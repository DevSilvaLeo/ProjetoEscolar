...
namespace Projeto.ControleEscolar.Application.Dtos
{
    ...
    public record TurmaOutputDto(Guid Id, string Nome, string Status, DateTime DataInicio, ICollection<DisciplinaOutputDto> Disciplinas, ICollection<AlunoOutputDto> Alunos);
}